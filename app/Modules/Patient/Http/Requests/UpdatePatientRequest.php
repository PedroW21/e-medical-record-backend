...
final class UpdatePatientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'blood_type' => ['nullable', 'string', Rule::in(array_column(BloodType::cases(), 'value'))],
            ...
            'medical_history.smoking' => ['nullable', 'string', Rule::in(array_column(HabitIntensity::cases(), 'value'))],
            'medical_history.alcohol' => ['nullable', 'string', Rule::in(array_column(HabitIntensity::cases(), 'value'))],
