...
/**
 * @mixin \App\Modules\MedicalRecord\Models\RegistroTemperatura
 */
final class TemperatureResultResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $map = self::dbToApiMap(ExamType::Temperature);
