...
final class StoreExamRequestRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.id.required' => 'Cada item deve ter um identificador.',
            'items.*.id.max' => 'O identificador do item não pode ter mais de 255 caracteres.',
            'items.*.name.required' => 'Cada item deve ter um nome.',
            ...
            'items.*.selected.required' => 'O campo selecionado é obrigatório para cada item.',
