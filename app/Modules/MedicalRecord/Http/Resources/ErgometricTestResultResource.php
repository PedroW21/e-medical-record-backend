...
/**
 * @mixin \App\Modules\MedicalRecord\Models\ResultadoTesteErgometrico
 */
final class ErgometricTestResultResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $map = self::dbToApiMap(ExamType::ErgometricTest);
