...
/**
 * @mixin \App\Modules\MedicalRecord\Models\ResultadoElastografiaHepatica
 */
final class HepaticElastographyResultResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $map = self::dbToApiMap(ExamType::HepaticElastography);
