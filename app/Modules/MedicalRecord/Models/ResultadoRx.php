 ...
 */
class ResultadoRx extends Model
{
    use HasFactory;

    protected $table = 'resultados_rx';
    ...
    protected static function newFactory(): \App\Modules\MedicalRecord\Database\Factories\XrayResultFactory
    {
        return \App\Modules\MedicalRecord\Database\Factories\XrayResultFactory::new();
    }
}
