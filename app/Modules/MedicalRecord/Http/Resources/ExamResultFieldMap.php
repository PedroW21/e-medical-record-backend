    ...
    public static function apiToDbMap(ExamType $examType): array
    {
        ...
        $specific = match ($examType) {
            ...
            ExamType::CarotidEcodoppler => [
                ...
                'internal_carotid_left.intimal_thickness' => 'espessura_intimal_carotida_interna_e',
                'internal_carotid_left.stenosis_degree' => 'grau_estenose_carotida_interna_e',
                'internal_carotid_right.intimal_thickness' => 'espessura_intimal_carotida_interna_d',
                'internal_carotid_right.stenosis_degree' => 'grau_estenose_carotida_interna_d',
