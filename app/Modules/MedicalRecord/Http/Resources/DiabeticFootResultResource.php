...
/**
 * @mixin \App\Modules\MedicalRecord\Models\ResultadoPeDiabetico
 */
final class DiabeticFootResultResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $map = self::dbToApiMap(ExamType::DiabeticFoot);
