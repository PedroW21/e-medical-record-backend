...
class ResultadoMrpa extends Model
{
    ...
    protected $table = 'resultados_mrpa';
    ...
    /**
     * @return HasMany<MedicaoMrpa, $this>
     */
    public function medicoes(): HasMany
    {
        return $this->hasMany(MedicaoMrpa::class);
    }

    protected static function newFactory(): \App\Modules\MedicalRecord\Database\Factories\MrpaResultFactory
    {
        return \App\Modules\MedicalRecord\Database\Factories\MrpaResultFactory::new();
    }
}
