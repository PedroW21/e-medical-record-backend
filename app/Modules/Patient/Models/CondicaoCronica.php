...
/**
 * Chronic condition model mapped to the "condicoes_cronicas" table.
 *
 * @property int $id
...
class CondicaoCronica extends Model
{
    ...
    protected static function newFactory(): \App\Modules\Patient\Database\Factories\ChronicConditionFactory
    {
        return \App\Modules\Patient\Database\Factories\ChronicConditionFactory::new();
    }
}
